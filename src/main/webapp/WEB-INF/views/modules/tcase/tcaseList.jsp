...
<body>
	...
	<form:form id="searchForm" modelAttribute="tcase" action="${ctx}/case/tcase/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>受理时间：</label>
				<input name="acceptDateFrom" type="text" readonly="readonly" maxlength="20" class="input-small Wdate"
				...
				<input name="acceptDateTo" type="text" readonly="readonly" maxlength="20" class="input-small Wdate"
			...
			<li><label class="control-label">我的案件：</label>
				<form:checkbox path="myCaseFlag"/>
			</li>								
