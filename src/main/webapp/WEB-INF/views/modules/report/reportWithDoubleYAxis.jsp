...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<form:form id="searchForm" modelAttribute="reportParam" action="${ctx}/report/report/query" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			<li>
			<c:choose>
			   <c:when test="${reportParam.reportType eq 'yearReport' }">
			    <label>年份 ：</label>
  ...
  <tr>
    <td>
	    <report:doubleYAxisChartAndTable gridColModel="${reportData.tableData.jsonColModel}" chartSeries="${reportData.chartData.jsonSeries}" 
	    chartyTitle1="${reportData.chartData.yTitle1}" chartyTitle2="${reportData.chartData.yTitle2}"
	    chartCategories="${reportData.chartData.jsonCategories}" gridData="${reportData.tableData.jsonData}" 
	    chartTitle="${reportData.chartData.title}" chartSubTitle="" 
	    chartyAxisUnit1="${reportData.chartData.yAxisUnit1}" chartyAxisUnit2="${reportData.chartData.yAxisUnit2}">	
	    </report:doubleYAxisChartAndTable>    
