 ...
 */
package org.wxjs.les.modules.sys.service;
...
import org.wxjs.les.common.security.Digests;
import org.wxjs.les.common.security.shiro.session.SessionDAO;
import org.wxjs.les.common.service.BaseService;
import org.wxjs.les.common.service.ServiceException;
import org.wxjs.les.common.utils.CacheUtils;
import org.wxjs.les.common.utils.Encodes;
import org.wxjs.les.common.utils.StringUtils;
import org.wxjs.les.common.web.Servlets;
import org.wxjs.les.modules.sys.dao.MenuDao;
import org.wxjs.les.modules.sys.dao.RoleDao;
...
import org.wxjs.les.modules.sys.security.SystemAuthorizingRealm;
import org.wxjs.les.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	/**
	 * 通过 区域ID获取用户列表，仅返回用户id和name（树查询用户时用）
	 * @param user
	 * @return
	 */
	@SuppressWarnings("unchecked")
	public List<User> findUserByAreaId(String areaId) {
		...
		if (list == null){
			...
			user.setOffice(officeParam);
			list = userDao.findList(user);
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - 千里目软件\r\n");
		sb.append("\r\n======================================================================\r\n");
