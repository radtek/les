 ...
 */
package org.wxjs.les.modules.task.service;
...
import org.wxjs.les.modules.act.service.creator.MultiInstanceActivityCreator;
import org.wxjs.les.modules.act.service.creator.RuntimeActivityDefinitionEntityIntepreter;
import org.wxjs.les.modules.act.service.creator.SimpleRuntimeActivityDefinitionEntity;
...
public class CaseTaskService extends BaseService {
	 ...
	 * @return
	 */
	public List<CaseAct> todoList(CaseAct act){
		String userId = UserUtils.getUser().getLoginName();//ObjectUtils.toString(UserUtils.getUser().getId());
		
		List<CaseAct> result = new ArrayList<CaseAct>();
...
//			e.setProcExecUrl(ActUtils.getProcExeUrl(task.getProcessDefinitionId()));
	 ...
	 * @return
	 */
	public Page<CaseAct> historicList(Page<CaseAct> page, CaseAct act){
		String userId = UserUtils.getUser().getLoginName();//ObjectUtils.toString(UserUtils.getUser().getId());
...
//			e.setProcExecUrl(ActUtils.getProcExeUrl(task.getProcessDefinitionId()));
	 ...
	 */
	public List<CaseAct> histoicFlowList(String procInsId, String startAct, String endAct){
		List<CaseAct> actList = Lists.newArrayList();
