 ...
 */
package org.wxjs.les.modules.task.entity;
 ...
 * @version 2013-11-03
 */
public class CaseAct extends BaseEntity<CaseAct> {
...
//	}
	...
	public List<CaseAct> getList() {
		return list;
	}

	public void setList(List<CaseAct> list) {
		this.list = list;
	}
